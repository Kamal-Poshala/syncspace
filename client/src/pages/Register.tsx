...
import { User, Lock, Github, Chrome, ArrowRight, Sparkles } from "lucide-react";
        ...
        <div className="relative min-h-screen w-full overflow-hidden bg-[#030303] font-sans text-white">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
                <motion.div
                    ...
                    className="absolute -bottom-[10%] -left-[10%] h-[500px] w-[500px] rounded-full bg-blue-600/20 blur-[120px]"
                />
                <motion.div
                    animate={{
                        scale: [1.3, 1, 1.3],
                    ...
                    className="absolute top-[10%] -right-[10%] h-[600px] w-[600px] rounded-full bg-indigo-600/10 blur-[150px]"
                />
            ...
            <div className="relative z-10 flex min-h-screen items-center justify-center px-4">
                ...
                >
                    ...
                    <div className="group relative rounded-3xl border border-white/10 bg-white/5 p-8 shadow-2xl backdrop-blur-2xl transition-all duration-500 hover:border-white/20">
                        ...
                        <div className="mt-8 space-y-6">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-xs uppercase tracking-widest"><span className="bg-[#0f0f0f] px-4 text-gray-500">Or register with</span></div>
                            </div>
                    ...
                    >
                        ...
                        <Link to="/login" className="font-semibold text-white hover:text-blue-500 transition-colors underline-offset-4 hover:underline">
                            Sign in instead
                        </Link>
                    </motion.div>
                </motion.div>
